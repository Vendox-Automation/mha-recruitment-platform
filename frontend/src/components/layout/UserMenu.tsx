 ...
 * name linking to their role-aware workspace (candidate, employer, or admin),
 * plus secure sign-out. Replaces the Sign In / Create Account actions once a
 * session is present, so an authenticated user is never shown as a guest on
 * public routes.
 */
